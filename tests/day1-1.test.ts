import { add, combineFirstAndLastDigit, reduceTransformLinesFromInputFile, } from "../src/day1-1";
...
test("sumAllCalibrationsInDocument", () => {
    expect(reduceTransformLinesFromInputFile("../asset/input-test.txt", combineFirstAndLastDigit, add)).toBe(142);
});
